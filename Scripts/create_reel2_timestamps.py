#!/usr/bin/env python3
"""
Extract transcript segment and create word-level timestamps for Reel #2
"""
...
# Main execution for Reel #2
if __name__ == "__main__":
    # Reel 2: [09:20.914] to [10:05.974]
    transcript_file = 'podcast_audio_30min_transcription.txt'
    start_time = '[00:09:20.914]'
    end_time = '[00:10:05.974]'
    output_file = 'reel2.txt'
